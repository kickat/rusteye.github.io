...
public class YmlUtils {
	public static Object getValueMap(String key){
		...
		try {
			...
			File file=ResourceUtils.getFile("classpath:application-"+ env +".yml");
...
public class RedisUtil {
	private static Map<String, Map<String, String>> makeKey = (Map<String, Map<String, String>>) YmlUtils.getValueMap("redis");
